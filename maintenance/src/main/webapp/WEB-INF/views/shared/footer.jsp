    ...
    <div class="kpx_login">
         <div class="row">
          <div class="col-lg-6">
                    <p>Copyright &copy; Managem 2019 - Designed and Developed By BOUKOUB Imrane</p>
                </div>
                <div class="col-lg-6">
          <div class="col-xs-1 col-sm-1">
            <a href="https://github.com/boukoub107" class="btn btn-lg btn-block kpx_btn-github" data-toggle="tooltip" data-placement="top" title="GitHub">
              <i class="fa fa-github fa-2x"></i>
              <span class="hidden-xs"></span>
            </a>
          </div>
          <div class="col-xs-& col-sm-1">
            <a href="https://www.facebook.com/imran.boukoub.1" class="btn btn-lg btn-block kpx_btn-facebook" data-toggle="tooltip" data-placement="top" title="Facebook">
              <i class="fa fa-facebook fa-2x"></i>
              <span class="hidden-xs"></span>
            </a>
          </div>
          <div class="col-xs-1 col-sm-1">
            <a href="https://www.linkedin.com/in/imran-boukoub-b630a6169" class="btn btn-lg btn-block kpx_btn-linkedin" data-toggle="tooltip" data-placement="top" title="LinkedIn">
