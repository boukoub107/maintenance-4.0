			...
			<div class="panel panel-primary">
				...
				<div class="panel-body">
					<sf:form class="form-horizontal" modelAttribute="product"
						...
						<div class="form-group">
							<label class="control-label col-md-4">Upload a file PDF</label>
							<div class="col-md-8">
								<sf:input type="file" path="filpdf" class="form-control" />
								<sf:errors path="filpdf" cssClass="help-block" element="em" />
							</div>
						</div>
